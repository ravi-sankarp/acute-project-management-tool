...
import { useUserSignupMutation } from '../../redux/features/api/authApiSlice';
      ...
      >
        ...
        >
          ...
          <Grid
            ...
            xs={12}
          >
            <LabelStyled htmlFor="phoneNumber">Phone Number</LabelStyled>
            <InputField
            ...
            <ErrorField style={errors.phoneNumber ? {} : { marginBottom: '19px' }}>
